...
CREATE TABLE `order_item` (
  `id` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '订单商品ID',
  `order_id` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '订单ID',
  `sku_id` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '商品SKU ID',
...
CREATE TABLE `order_main` (
  `id` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '订单ID',
  `order_sn` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '订单号(ORDER202411180001)',
  ...
  `currency` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'USD' COMMENT '货币',
  `address_id` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '收货地址ID，关联user_address表',
  `receiver_name` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '收货人（地址快照）',
  `receiver_phone` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '电话（地址快照）',
  `receiver_address` varchar(500) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '完整收货地址（地址快照）',
...
CREATE TABLE `order_payment` (
  `id` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '支付ID',
  `order_id` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '订单ID',
  `payment_method` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '支付方式',
  `payment_amount` decimal(10,2) NOT NULL COMMENT '支付金额',
  `payment_status` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending' COMMENT '状态:pending,paid,failed,refunded',
  `gateway_trade_no` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '支付平台交易号',
  `created_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE `order_refund` (
  `id` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '退单ID',
  `refund_sn` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '退单号(REFUND202411180001)',
  `order_id` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '订单ID',
  `user_id` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '用户ID',
  `refund_type` tinyint NOT NULL COMMENT '退单类型:1仅退款 2退货退款',
  `refund_reason` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '退单原因',
  `apply_amount` decimal(10,2) NOT NULL COMMENT '申请退款金额',
  `actual_amount` decimal(10,2) DEFAULT NULL COMMENT '实际退款金额',
  ...
  `approver_id` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '审核人ID',
  `approver_notes` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '审核意见',
  `return_logistics` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '退货物流公司',
  `return_tracking_no` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '退货物流单号',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='订单退单表';
...
CREATE TABLE `product` (
  ...
  `brand_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '品牌ID',
  `name` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '商品名称',
  `sub_title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '副标题',
  ...
  `specs` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT '商品规格参数(JSON格式)',
  `price_range` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '价格区间(如100-200)',
  `sales` int DEFAULT '0' COMMENT '销量',
  `status` tinyint DEFAULT '1' COMMENT '状态(0-下架，1-上架)',
  `is_deleted` tinyint(1) DEFAULT '0' COMMENT '是否删除(0-未删除，1-已删除)',
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `default_supplier_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '默认供应商ID',
  PRIMARY KEY (`id`) USING BTREE,
  KEY `idx_category_id` (`category_id`) USING BTREE,
  KEY `idx_brand_id` (`brand_id`) USING BTREE,
  KEY `idx_status` (`status`) USING BTREE,
  KEY `idx_default_supplier_id` (`default_supplier_id`) USING BTREE,
  CONSTRAINT `product_chk_1` CHECK (json_valid(`specs`))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='商品表(SPU)';
...
CREATE TABLE `product_category` (
  ...
  `image` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '图',
...
CREATE TABLE `product_sku_supplier` (
  `id` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '主键ID',
  `sku_id` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'SKU ID',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='SKU与供应商关联关系表';
...
CREATE TABLE `product_spu_categorytag` (
  ...
  `spu_id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'SPU ID',
  `category_tag_id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '品类标签ID',
  `is_primary` tinyint(1) DEFAULT '0' COMMENT '是否主要标签',
  `sort_order` int DEFAULT '0' COMMENT '排序值',
  `created_time` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='SPU-品类标签关系表';
...
CREATE TABLE `product_spu_sku_rel` (
  ...
  KEY `idx_sku_id` (`sku_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='SPU-SKU关联关系表';
...
CREATE TABLE `product_spu_wuxing` (
  ...
  `spu_id` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'SPU ID',
  `wu_xing_id` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '五行属性ID',
  `element_strength` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '50' COMMENT '元素强度1-100',
  `is_primary` tinyint(1) DEFAULT '0' COMMENT '是否主要元素',
  `sort_order` int DEFAULT '0' COMMENT '排序值',
  `created_time` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='SPU-五行关系表';
...
CREATE TABLE `shopingcart` (
  `id` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '购物车项ID',
  `user_id` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '用户ID',
  `sku_id` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '商品SKU ID',
  ...
  `currency` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'USD' COMMENT '货币',
  `added_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '加入时间',
  `updated_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`)
...
CREATE TABLE `user` (
  ...
  `nickname` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '新用户' COMMENT '用户昵称',
  ...
  `avatar_path` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '头像相对路径（存储在文件系统中的路径）',
  `avatar_original_name` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '原始头像文件名',
  `avatar_size` bigint DEFAULT NULL COMMENT '头像文件大小（字节）',
  `avatar_content_type` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '头像文件类型（MIME类型）',
...
CREATE TABLE `user_address` (
  ...
  `user_id` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '用户ID',
  `address_name` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '地址名称(如：家、公司)',
  `is_default` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否默认地址',
  `receiver_name` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '收货人姓名',
  `phone_country_code` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '+86' COMMENT '国际区号',
  `phone_number` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '手机号码',
  ...
  `state_province` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '省/州',
  ...
  `street_address` varchar(500) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '详细地址',
...
CREATE TABLE `user_password_reset` (
  ...
  `is_used` tinyint(1) DEFAULT '0' COMMENT '是否已使用(0-未用 1-已用)',
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `uk_token` (`token`) USING BTREE,
  KEY `idx_user_id` (`user_id`) USING BTREE,
  KEY `idx_expires` (`expires_at`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='密码重置令牌表';
...
CREATE TABLE `wu_xing_attribute` (
  `id` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '主键ID',
  `element_key` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '五行元素键名',
  `element_code` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '五行代码',
  ...
  `element_name_en` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '英文名称',
  `element_name_zh` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '中文名称',
  `element_name_ar` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '阿拉伯语名称',
  `symbol_character` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '象征字符',
  `symbol_color` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '象征颜色代码',
  `symbol_color_gradient` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '渐变色系',
  `symbol_direction` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '象征方位',
  `symbol_season` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '象征季节',
  `symbol_time` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '象征时辰',
  `symbol_planet` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '象征行星',
  `symbol_weather` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '象征气候',
  `symbol_landform` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '象征地貌',
  `symbol_animal` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '象征动物',
  `symbol_plant` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '象征植物',
  `symbol_organ` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '象征脏腑',
  `symbol_sense` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '象征感官',
  `symbol_tissue` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '象征组织',
  `symbol_emotion` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '象征情绪',
  `symbol_sound` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '象征声音',
  `symbol_taste` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '象征味道',
  `symbol_virtue` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '象征品德',
  `symbol_career` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '象征职业',
  `symbol_number` tinyint DEFAULT NULL COMMENT '象征数字',
  `symbol_music` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '象征音律',
  `philosophy_meaning_zh` text COLLATE utf8mb4_unicode_ci COMMENT '中文哲学本义',
  `philosophy_meaning_en` text COLLATE utf8mb4_unicode_ci COMMENT '英文哲学本义',
  `cosmology_meaning_zh` text COLLATE utf8mb4_unicode_ci COMMENT '中文宇宙观含义',
  `cosmology_meaning_en` text COLLATE utf8mb4_unicode_ci COMMENT '英文宇宙观含义',
  `life_philosophy_zh` text COLLATE utf8mb4_unicode_ci COMMENT '中文生命哲学',
  `life_philosophy_en` text COLLATE utf8mb4_unicode_ci COMMENT '英文生命哲学',
  `change_principle_zh` text COLLATE utf8mb4_unicode_ci COMMENT '中文变化法则',
  `change_principle_en` text COLLATE utf8mb4_unicode_ci COMMENT '英文变化法则',
  `cultural_symbolism_zh` text COLLATE utf8mb4_unicode_ci COMMENT '中文文化象征',
  `cultural_symbolism_en` text COLLATE utf8mb4_unicode_ci COMMENT '英文文化象征',
  `mythological_association_zh` text COLLATE utf8mb4_unicode_ci COMMENT '中文神话关联',
  `mythological_association_en` text COLLATE utf8mb4_unicode_ci COMMENT '英文神话关联',
  `historical_reference_zh` text COLLATE utf8mb4_unicode_ci COMMENT '中文历史典故',
  `historical_reference_en` text COLLATE utf8mb4_unicode_ci COMMENT '英文历史典故',
  `artistic_expression_zh` text COLLATE utf8mb4_unicode_ci COMMENT '中文艺术表现',
  `artistic_expression_en` text COLLATE utf8mb4_unicode_ci COMMENT '英文艺术表现',
  `energy_essence_zh` text COLLATE utf8mb4_unicode_ci COMMENT '中文能量本质',
  `energy_essence_en` text COLLATE utf8mb4_unicode_ci COMMENT '英文能量本质',
  `energy_manifestation_zh` text COLLATE utf8mb4_unicode_ci COMMENT '中文能量显现',
  `energy_manifestation_en` text COLLATE utf8mb4_unicode_ci COMMENT '英文能量显现',
  `spiritual_meaning_zh` text COLLATE utf8mb4_unicode_ci COMMENT '中文灵性意义',
  `spiritual_meaning_en` text COLLATE utf8mb4_unicode_ci COMMENT '英文灵性意义',
  `personality_archetype_zh` text COLLATE utf8mb4_unicode_ci COMMENT '中文人格原型',
  `personality_archetype_en` text COLLATE utf8mb4_unicode_ci COMMENT '英文人格原型',
  ...
  `healing_property_zh` text COLLATE utf8mb4_unicode_ci COMMENT '中文疗愈属性',
  `healing_property_en` text COLLATE utf8mb4_unicode_ci COMMENT '英文疗愈属性',
  `generates_element` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '相生元素',
  `generated_by_element` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '被生元素',
  `restrains_element` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '相克元素',
  `restrained_by_element` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '被克元素',
  `relationship_meaning_zh` text COLLATE utf8mb4_unicode_ci COMMENT '中文关系意义',
  `relationship_meaning_en` text COLLATE utf8mb4_unicode_ci COMMENT '英文关系意义',
  `symbol_icon_url` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '象征图标URL',
  `philosophy_image_url` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '哲学图解URL',
  `energy_flow_image_url` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '能量流动图URL',
  `sort_order` int NOT NULL DEFAULT '0' COMMENT '排序值',
  `element_tier` tinyint NOT NULL DEFAULT '1' COMMENT '元素层级',
  `is_active` tinyint(1) NOT NULL DEFAULT '1' COMMENT '是否启用',
  `created_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `symbol_icon_id` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '象征图标ID（用于UI展示的小图标）',
  `philosophy_image_id` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '哲学原理图ID（五行相生相克关系图）',
  `energy_flow_image_id` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '能量流动图ID（能量流动示意图）',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='五行哲学文化属性表(完整版)';
