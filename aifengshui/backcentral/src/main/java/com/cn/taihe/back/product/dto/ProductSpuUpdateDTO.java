...
@ApiModel(value = "ProductSpuUpdateDTO", description = "商品SPU更新DTO")
public class ProductSpuUpdateDTO implements Serializable {
  ...
  @ApiModelProperty(value = "英文产品名称")
  private String productNameEn;

  @Length(max = 200, message = "中文产品名称长度不能超过200个字符")
  @ApiModelProperty(value = "中文产品名称")
