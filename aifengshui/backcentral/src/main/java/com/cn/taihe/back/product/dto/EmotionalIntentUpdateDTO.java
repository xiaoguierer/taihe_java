...
@ApiModel(value = "EmotionalIntentUpdateDTO", description = "情感意图更新数据传输对象")
public class EmotionalIntentUpdateDTO {
  ...
  // ==================== 基础标识字段 ====================
  @ApiModelProperty(value = "意图键名", example = "love_and_care")
  private String intentKey;

  @ApiModelProperty(value = "意图代码", example = "LOVE001")
  private String intentCode;

  @ApiModelProperty(value = "意图分类:primary主要,extended扩展,combined组合", example = "primary")
  private String intentCategory;

  // ==================== 多语言名称 ====================
  @ApiModelProperty(value = "英文名称", example = "Love and Care")
  private String intentNameEn;

  @ApiModelProperty(value = "中文名称", example = "爱与关怀")
  ...
  // ==================== 核心象征属性 ====================
  @ApiModelProperty(value = "象征字符", example = "❤️")
  private String symbolCharacter;

  @ApiModelProperty(value = "象征颜色代码", example = "#FF6B6B")
  ...
  @ApiModelProperty(value = "状态:0-冻结,1-启用,2-删除", example = "1")
  private Integer isActive;

  @ApiModelProperty(value = "是否在导航显示", example = "1")
  private Integer showInNavigation;

  @ApiModelProperty(value = "是否在筛选器显示", example = "1")
