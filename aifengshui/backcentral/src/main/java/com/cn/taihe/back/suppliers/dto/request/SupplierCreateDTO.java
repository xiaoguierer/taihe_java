...
@ApiModel(value = "SupplierCreateDTO", description = "供应商新增DTO")
public class SupplierCreateDTO {
    ...
    @ApiModelProperty(value = "注册资本(万元)", example = "500.00")
    private BigDecimal registeredCapital;

    @NotBlank(message = "注册地址不能为空")
    @Size(max = 500, message = "注册地址长度不能超过500")
    @ApiModelProperty(value = "注册地址", required = true, example = "上海市浦东新区张江高科技园区XX路123号")
